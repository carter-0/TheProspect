            ...
            <main className={"bg-gradient-to-r from-[#b3b19c] to-[#dbd1ad]"}>
                ...
                <div className={"flex flex-col xl:flex-row py-40 justify-center items-start space-y-12 xl:space-y-0 xl:space-x-12"}>
                    <div className="max-w-3xl w-full">
                        ...
                        <iframe className="rounded-md px-5" src="https://open.spotify.com/embed/artist/3J0kdDxbvMahTwwWltkG2w?utm_source=generator" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    </div>
